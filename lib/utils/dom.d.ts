...
export declare function ownerDocument(componentOrElement: any): any;
export declare function calculatePosition(placement: any, overlayNode: any, target: any, container: any, padding: any): {
    positionLeft: number;
    positionTop: number;
    arrowOffsetLeft: any;
    arrowOffsetTop: any;
