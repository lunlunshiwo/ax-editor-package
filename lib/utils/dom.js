...
var domHelperWwnerDocument = require("dom-helpers/ownerDocument");
var getOffset = require("dom-helpers/query/offset");
var getPosition = require("dom-helpers/query/position");
var getScrollTop = require("dom-helpers/query/scrollTop");
var bsMapping = {
    level: 'bsStyle',
    classPrefix: 'bsClass',
    size: 'bsSize'
 ...
 * @return {Object}
 */
exports.props2BsProps = function (rawProps) {
    var props = {};
 ...
 * @return {Component}
 */
exports.props2BsPropsHoc = function (ComposedComponent) {
    var BsComponent = /** @class */ (function (_super) {
        tslib_1.__extends(BsComponent, _super);
        function BsComponent() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        BsComponent.prototype.render = function () {
            return react_1.default.createElement(ComposedComponent, tslib_1.__assign({}, exports.props2BsProps(this.props)));
        };
        return BsComponent;
...
function ownerDocument(componentOrElement) {
    return domHelperWwnerDocument(react_dom_1.default.findDOMNode(componentOrElement));
}
...
function getContainerDimensions(containerNode) {
    ...
    if (containerNode.tagName === 'BODY') {
        ...
        (_a = getOffset(containerNode), width = _a.width, height = _a.height);
...
function calculatePosition(placement, overlayNode, target, container, padding) {
    ...
    var _a = getOffset(overlayNode), overlayHeight = _a.height, overlayWidth = _a.width;
    // auto 尝试四个方向对齐。
    placement =
        placement === 'auto'
    ...
    if (~placement.indexOf('-')) {
        ...
        while (tests.length) {
            ...
            if (tests.length) {
                var clip = target.getBoundingClientRect();
                var transformed = {
