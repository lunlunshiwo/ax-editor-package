...
var List = /** @class */ (function (_super) {
    ...
    List.prototype.handleQuickChange = function (item, values, saveImmediately, savePristine) {
    ...
    List.prototype.handleSave = function () {
        var _a = this.props, store = _a.store, onSave = _a.onSave;
    ...
    List.prototype.initDragging = function () {
        ...
        var dom = react_dom_1.findDOMNode(this);
        var ns = this.props.classPrefix;
        this.sortable = new Sortable(dom.querySelector("." + ns + "List-items"), {
            group: 'table',
            animation: 150,
    ...
    List.prototype.renderDragToggler = function () {
        ...
        return (react_1.default.createElement(Button_1.default, { iconOnly: true, key: "dragging-toggle", tooltip: "\u5BF9\u5217\u8868\u8FDB\u884C\u6392\u5E8F\u64CD\u4F5C", tooltipContainer: env && env.getModalContainer ? env.getModalContainer : undefined, size: "sm", active: store.dragging, onClick: function (e) {
            ...
            react_1.default.createElement("i", { className: "fa fa-exchange" })));
    };
    ...
    List.prototype.render = function () {
        var _a;
        var _this = this;
        var _b = this.props, className = _b.className, itemClassName = _b.itemClassName, store = _b.store, placeholder = _b.placeholder, render = _b.render, multiple = _b.multiple, listItem = _b.listItem, onAction = _b.onAction, hideCheckToggler = _b.hideCheckToggler, checkOnItemClick = _b.checkOnItemClick, affixHeader = _b.affixHeader, cx = _b.classnames, size = _b.size;
        ...
        return (react_1.default.createElement("div", { className: cx('List', className, (_a = {},
            ...
            store.items.length ? (react_1.default.createElement("div", { className: cx('List-items') }, store.items.map(function (item, index) {
                return render("" + index, tslib_1.__assign({ type: 'list-item' }, listItem), {
                    key: item.index,
            ...
            }))) : (react_1.default.createElement("div", { className: cx('List-placeholder') }, placeholder)),
            this.renderFooter()));
    };
    List.propsList = [
        'header',
...
var ListRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(ListRenderer, _super);
...
var ListItem = /** @class */ (function (_super) {
    ...
    ListItem.prototype.handleQuickChange = function (values, saveImmediately, savePristine) {
    ...
    ListItem.prototype.renderRight = function () {
        ...
        if (Array.isArray(actions)) {
            return (react_1.default.createElement("div", { className: cx('ListItem-actions') }, actions.map(function (action, index) {
                ...
                return render("action/" + index, tslib_1.__assign({ size: 'sm', level: 'link', type: 'button' }, action), {
                    key: index,
    ...
    ListItem.prototype.renderFeild = function (region, field, key, props) {
        var render = props.render || this.props.render;
        ...
        return (react_1.default.createElement("div", { key: key, className: cx('ListItem-field') },
            ...
            render(region, tslib_1.__assign(tslib_1.__assign({}, field), { field: field, $$id: $$id, type: 'list-item-field' }), {
                rowIndex: itemIndex,
                colIndex: key,
    ...
    ListItem.prototype.render = function () {
        var _a = this.props, className = _a.className, data = _a.data, avatarTpl = _a.avatar, titleTpl = _a.title, titleClassName = _a.titleClassName, subTitleTpl = _a.subTitle, descTpl = _a.desc, avatarClassName = _a.avatarClassName, checkOnItemClick = _a.checkOnItemClick, render = _a.render, checkable = _a.checkable, cx = _a.classnames;
        var avatar = tpl_1.filter(avatarTpl, data);
        var title = tpl_1.filter(titleTpl, data);
        var subTitle = tpl_1.filter(subTitleTpl, data);
        var desc = tpl_1.filter(descTpl, data);
        return (react_1.default.createElement("div", { onClick: checkOnItemClick && checkable ? this.handleClick : undefined, className: cx('ListItem', className) },
            this.renderLeft(),
            this.renderRight(),
...
var ListItemRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(ListItemRenderer, _super);
...
var ListItemFieldRenderer = /** @class */ (function (_super) {
    ...
    ListItemFieldRenderer.defaultProps = tslib_1.__assign(tslib_1.__assign({}, Table_1.TableCell.defaultProps), { wrapperComponent: 'div' });
    ListItemFieldRenderer.propsList = tslib_1.__spreadArrays([
        'quickEdit',
        'popOver',
        'copyable'
