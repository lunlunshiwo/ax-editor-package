...
var Dialog = /** @class */ (function (_super) {
    ...
    Dialog.prototype.buildActions = function () {
        var _a = this.props, actions = _a.actions, confirm = _a.confirm;
    ...
    Dialog.prototype.renderBody = function (body, key) {
        ...
        if (schema.type === 'form') {
            ...
            subProps.onChange = helper_1.chainFunctions(this.handleFormChange, schema.onChange);
            subProps.onInit = helper_1.chainFunctions(this.handleFormInit, schema.onInit);
            subProps.onSaved = helper_1.chainFunctions(this.handleFormSaved, schema.onSaved);
        }
    ...
    Dialog.prototype.renderFooter = function () {
        ...
        return (react_1.default.createElement("div", { className: cx('Modal-footer') },
            store.loading || store.error ? (react_1.default.createElement("div", { className: cx('Dialog-info'), key: "info" },
                ...
                store.error ? (react_1.default.createElement("span", { className: cx('Dialog-error') }, store.msg)) : null)) : null,
    ...
    Dialog.prototype.render = function () {
        ...
        return (react_1.default.createElement(Wrapper, { classPrefix: classPrefix, className: cx(className), size: size, backdrop: "static", onHide: this.handleSelfClose, keyboard: closeOnEsc && !store.loading, closeOnEsc: closeOnEsc, show: show, onEntered: this.handleEntered, onExited: this.handleExited, container: env && env.getModalContainer ? env.getModalContainer : undefined, enforceFocus: false, disabled: store.loading },
            title && typeof title === 'string' ? (react_1.default.createElement("div", { className: cx('Modal-header', headerClassName) },
                showCloseButton !== false && !store.loading ? (react_1.default.createElement("a", { "data-tooltip": "\u5173\u95ED\u5F39\u7A97", onClick: this.handleSelfClose, className: cx('Modal-close') },
                    react_1.default.createElement(icons_1.Icon, { icon: "close", className: "icon" }))) : null,
                react_1.default.createElement("div", { className: cx('Modal-title') }, tpl_1.filter(title, store.formData)))) : title ? (react_1.default.createElement("div", { className: cx('Modal-header', headerClassName) },
                showCloseButton !== false && !store.loading ? (react_1.default.createElement("a", { "data-tooltip": "\u5173\u95ED\u5F39\u7A97", onClick: this.handleSelfClose, className: cx('Modal-close') },
                    react_1.default.createElement(icons_1.Icon, { icon: "close", className: "icon" }))) : null,
                render('title', title, {
                    data: store.formData
            ...
            header
                ...
                : null,
            !this.state.entered && lazyRender ? (react_1.default.createElement("div", { className: cx('Modal-body', bodyClassName) })) : body ? (react_1.default.createElement("div", { className: cx('Modal-body', bodyClassName) }, this.renderBody(body, 'body'))) : null,
            this.renderFooter(),
            body
...
var DialogRenderer = /** @class */ (function (_super) {
    ...
    DialogRenderer.prototype.tryChildrenToHandle = function (action, ctx, rawAction) {
        ...
        if (!targets.length) {
            var form = findLast(components, function (component) { return component.props.type === 'form'; });
            form && targets.push(form);
            var crud = findLast(components, function (component) { return component.props.type === 'crud'; });
    ...
    DialogRenderer.prototype.handleAction = function (e, action, data, throwErrors, delegate) {
        ...
        if (action.type === 'reset') {
            ...
            store
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            action.redirect &&
                                env.jumpTo(tpl_1.filter(action.redirect, store.data), action);
            ...
            var ret = onAction(e, action, data, throwErrors, true);
            action.close &&
                (ret && ret.then
