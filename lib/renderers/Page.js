...
var Page = /** @class */ (function (_super) {
    ...
    Page.prototype.handleAction = function (e, action, ctx, delegate) {
        var _this = this;
        ...
        if (action.actionType === 'url' ||
            ...
            env.jumpTo(tpl_1.filter((action.to || action.url || action.link), ctx), action, ctx);
        }
            ...
            env.copy && env.copy(tpl_1.filter(action.content || action.copy, ctx));
        }
    };
    ...
    Page.prototype.renderHeader = function () {
        var _a = this.props, title = _a.title, subTitle = _a.subTitle, remark = _a.remark, headerClassName = _a.headerClassName, toolbarClassName = _a.toolbarClassName, toolbar = _a.toolbar, render = _a.render, store = _a.store, env = _a.env, cx = _a.classnames;
        var subProps = {
    ...
    Page.prototype.render = function () {
        var _a = this.props, className = _a.className, store = _a.store, body = _a.body, bodyClassName = _a.bodyClassName, render = _a.render, aside = _a.aside, asideClassName = _a.asideClassName, cx = _a.classnames, header = _a.header;
        var subProps = {
            onAction: this.handleAction,
...
var PageRenderer = /** @class */ (function (_super) {
    ...
    PageRenderer.prototype.handleAction = function (e, action, ctx, throwErrors, delegate) {
        ...
        if (action.actionType === 'reload') {
            ...
            _super.prototype.handleAction.call(this, e, action, ctx, delegate);
        }
    };
