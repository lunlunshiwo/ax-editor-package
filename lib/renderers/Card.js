...
var Card = /** @class */ (function (_super) {
    ...
    Card.prototype.handleQuickChange = function (values, saveImmediately, savePristine) {
    ...
    Card.prototype.render = function () {
        var _a = this.props, className = _a.className, data = _a.data, header = _a.header, render = _a.render, bodyClassName = _a.bodyClassName, highlightClassName = _a.highlightClassName, titleClassName = _a.titleClassName, subTitleClassName = _a.subTitleClassName, descClassName = _a.descClassName, checkOnItemClick = _a.checkOnItemClick, checkable = _a.checkable, cx = _a.classnames, ns = _a.classPrefix;
        var heading = null;
        if (header) {
            var highlightTpl = header.highlight, avatarTpl = header.avatar, avatarClassName = header.avatarClassName, imageClassName = header.imageClassName, titleTpl = header.title, subTitleTpl = header.subTitle, subTitlePlaceholder = header.subTitlePlaceholder, descTpl = header.desc, descPlaceholder = header.descPlaceholder;
            ...
            heading = (react_1.default.createElement("div", { className: cx('Card-heading', header.className) },
                avatar ? (react_1.default.createElement("span", { className: cx('Card-avtar', header.avatarClassName || avatarClassName) },
                    react_1.default.createElement("img", { className: cx('Card-img', header.imageClassName || imageClassName), src: avatar }))) : null,
                react_1.default.createElement("div", { className: cx('Card-meta') },
                    ...
                    desc || descPlaceholder ? (react_1.default.createElement("div", { className: cx('Card-desc', header.descClassName || descClassName) }, render('desc', desc || descPlaceholder, {
