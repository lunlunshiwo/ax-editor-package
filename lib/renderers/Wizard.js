...
var Wizard = /** @class */ (function (_super) {
    ...
    Wizard.prototype.componentDidMount = function () {
        var _this = this;
        var _a = this.props, initApi = _a.initApi, initFetch = _a.initFetch, initAsyncApi = _a.initAsyncApi, initFinishedField = _a.initFinishedField, store = _a.store, data = _a.data, _b = _a.messages, fetchSuccess = _b.fetchSuccess, fetchFailed = _b.fetchFailed, onInit = _a.onInit;
    ...
    Wizard.prototype.checkSubmit = function () {
        var _a;
        var _this = this;
        var _b = this.props, store = _b.store, steps = _b.steps, asyncApi = _b.asyncApi, finishedField = _b.finishedField, target = _b.target, redirect = _b.redirect, reload = _b.reload, env = _b.env, onFinished = _b.onFinished;
    ...
    Wizard.prototype.handleAction = function (e, action, data, throwErrors) {
        var _this = this;
    ...
    Wizard.prototype.handleDialogConfirm = function (values, action, ctx, targets) {
        var store = this.props.store;
        if (action.mergeData &&
            values.length === 1 &&
            values[0] &&
    ...
    Wizard.prototype.renderSteps = function () {
        var _this = this;
        var _a = this.props, steps = _a.steps, store = _a.store, mode = _a.mode, ns = _a.classPrefix;
    ...
    Wizard.prototype.renderActions = function () {
        ...
        if (step.actions && Array.isArray(step.actions)) {
            return step.actions.length ? (react_1.default.createElement("div", { className: cx('Panel-footer') }, step.actions.map(function (action, index) {
        ...
        return (react_1.default.createElement("div", { className: cx('Panel-footer') },
            render("prev-btn", {
                type: 'button',
    ...
    Wizard.prototype.render = function () {
        var _a = this.props, className = _a.className, steps = _a.steps, render = _a.render, store = _a.store, mode = _a.mode, ns = _a.classPrefix;
        var currentStep = this.state.currentStep;
...
var WizardRenderer = /** @class */ (function (_super) {
    ...
    WizardRenderer.prototype.handleDialogConfirm = function (values, action, ctx, targets) {
