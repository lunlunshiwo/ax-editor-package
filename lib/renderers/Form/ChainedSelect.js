...
var ChainedSelectControl = /** @class */ (function (_super) {
    tslib_1.__extends(ChainedSelectControl, _super);
    ...
    ChainedSelectControl.prototype.componentWillReceiveProps = function (nextProps) {
    ...
    ChainedSelectControl.prototype.loadMore = function () {
        ...
        this.setState({
            ...
            env
                .fetcher(source, tslib_1.__assign(tslib_1.__assign({}, data), { value: arr, level: idx + 1, parentId: parentId, parent: arr[idx] }))
                .then(function (ret) {
    ...
    ChainedSelectControl.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: classnames_1.default(ns + "ChainedSelectControl", className) },
            react_1.default.createElement(Select_1.default, tslib_1.__assign({}, rest, { classPrefix: ns, key: "base", options: options, value: arr[0], onChange: this.handleChange.bind(this, 0), loading: loading, inline: true })),
            this.state.stack.map(function (_a, index) {
                var options = _a.options, loading = _a.loading, visible = _a.visible;
                return visible === false ? null : (react_1.default.createElement(Select_1.default, tslib_1.__assign({}, rest, { classPrefix: ns, key: "x-" + (index + 1), options: options, value: arr[index + 1], onChange: _this.handleChange.bind(_this, index + 1), loading: loading, inline: true })));
            })));
    };
...
var ChainedSelectControlRenderer = /** @class */ (function (_super) {
    tslib_1.__extends(ChainedSelectControlRenderer, _super);
