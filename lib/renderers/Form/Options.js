...
function registerOptionsControl(config) {
    ...
    var FormOptionsItem = /** @class */ (function (_super) {
        ...
        FormOptionsItem.prototype.componentDidUpdate = function (prevProps) {
            ...
            if (prevProps.options !== props.options && formItem) {
                ...
                if (/^\$(?:([a-z0-9_.]+)|{.+})$/.test(props.source)) {
                    ...
                    formItem.loadOptions(props.source, props.data, undefined, true, props.onChange);
                }
            }
            this.normalizeValue();
        };
        ...
        FormOptionsItem.prototype.reload = function () {
            ...
            if (config.autoLoadOptionsFromSource === false ||
                !formItem ||
                !api_1.isEffectiveApi(source, data)) {
                return;
            }
        ...
        FormOptionsItem.prototype.handleOptionAdd = function (idx, value, skipForm) {
            ...
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, addControls, disabled, labelField, onOpenDialog, optionLabel, addApi, source, data, valueField, model, createBtnLabel, env, ctx, result, _b, payload, e_1, options;
                var _c;
                return tslib_1.__generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                            _a = this.props, addControls = _a.addControls, disabled = _a.disabled, labelField = _a.labelField, onOpenDialog = _a.onOpenDialog, optionLabel = _a.optionLabel, addApi = _a.addApi, source = _a.source, data = _a.data, valueField = _a.valueField, model = _a.formItem, createBtnLabel = _a.createBtnLabel, env = _a.env;
                            // 禁用或者没有配置 name
                            if (disabled || !model) {
                                return [2 /*return*/];
                            }
                            ...
                            ctx = helper_1.createObject(data, Array.isArray(idx)
                                ? tslib_1.__assign({ parent: helper_1.getTree(model.options, idx.slice(0, idx.length - 1)) }, value) : value);
        ...
        FormOptionsItem.prototype.handleOptionEdit = function (value, origin, skipForm) {
            ...
            if (skipForm === void 0) { skipForm = false; }
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, editControls, disabled, labelField, onOpenDialog, editApi, env, source, data, model, optionLabel, result, _b, payload, e_2, indexes;
                return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _a = this.props, editControls = _a.editControls, disabled = _a.disabled, labelField = _a.labelField, onOpenDialog = _a.onOpenDialog, editApi = _a.editApi, env = _a.env, source = _a.source, data = _a.data, model = _a.formItem, optionLabel = _a.optionLabel;
                            if (disabled || !model) {
                                return [2 /*return*/];
                            }
        ...
        FormOptionsItem.prototype.handleOptionDelete = function (value) {
            return tslib_1.__awaiter(this, void 0, void 0, function () {
                var _a, deleteConfirmText, disabled, data, deleteApi, env, model, source, valueField, ctx, confirmed, _b, result, options, idx, e_3;
                return tslib_1.__generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            _a = this.props, deleteConfirmText = _a.deleteConfirmText, disabled = _a.disabled, data = _a.data, deleteApi = _a.deleteApi, env = _a.env, model = _a.formItem, source = _a.source, valueField = _a.valueField;
                            if (disabled || !model) {
                                return [2 /*return*/];
                            }
        ...
        tslib_1.__decorate([
            helper_1.autobind,
            tslib_1.__metadata("design:type", Function),
            tslib_1.__metadata("design:paramtypes", [typeof (_a = typeof Select_1.Option !== "undefined" && Select_1.Option) === "function" ? _a : Object, Boolean]),
            tslib_1.__metadata("design:returntype", void 0)
