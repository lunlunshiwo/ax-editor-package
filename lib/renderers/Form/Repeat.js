...
var RepeatControl = /** @class */ (function (_super) {
    ...
    RepeatControl.prototype.renderInput = function () {
        ...
        var _a = this.props, options = _a.options, placeholder = _a.placeholder, disabled = _a.disabled, ns = _a.classPrefix;
        var optionsArray = [];
        ...
        return (react_1.default.createElement("div", { className: "repeat-control hbox" },
            input ? (react_1.default.createElement("div", { className: "col v-middle", style: { width: 30 } },
                react_1.default.createElement("span", null, "\u6BCF"))) : null,
            ...
            react_1.default.createElement("div", { className: "col v-middle repeat-btn" },
                react_1.default.createElement(Select_1.default, { classPrefix: ns, className: input ? 'pull-right' : null, options: optionsArray, placeholder: placeholder, onChange: this.handleOptionChange, value: parts[0], clearable: false, searchable: false, disabled: disabled, joinValues: false }))));
    };
...
//# sourceMappingURL=./renderers/Form/Repeat.js.map
