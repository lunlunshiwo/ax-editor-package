...
var RangeControl = /** @class */ (function (_super) {
    ...
    RangeControl.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        if (value !== nextPropsValue) {
            ...
            this.setState({
                value: value_1,
                minValue: isObject(value_1) ? value_1.min : min,
                maxValue: isObject(value_1) ? value_1.max : max
            });
        }
    };
    ...
    RangeControl.prototype.render = function () {
        ...
        return (react_1.default.createElement("div", { className: cx('RangeControl', {
            ...
            showInput ? (multiple && isObject(this.state.value) ? (react_1.default.createElement("div", { className: cx('InputRange-input is-multiple') },
                ...
                react_1.default.createElement("input", { className: this.state.value !== min ? 'is-active' : '', type: "text", name: name, value: !isObject(this.state.value) ? this.state.value : 0, disabled: disabled, onChange: this.handleInputChange })))) : null,
