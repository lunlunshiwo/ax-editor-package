...
var MatrixCheckbox = /** @class */ (function (_super) {
    ...
    MatrixCheckbox.prototype.componentWillReceiveProps = function (nextProps) {
        ...
        else if (nextProps.source !== props.source ||
    ...
    MatrixCheckbox.prototype.reload = function () {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var _a, source, data, env, onChange;
            var _this = this;
            return tslib_1.__generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props, source = _a.source, data = _a.data, env = _a.env, onChange = _a.onChange;
                                ...
                                _this.setState({
                                    ...
                                    env
                                        ...
                                        _this.setState({
                                            ...
                                            if (value) {
                                                value = mergeValue(value, _this.state.columns, _this.state.rows);
                                                onChange(value);
                                            }
                                            resolve();
                                        });
