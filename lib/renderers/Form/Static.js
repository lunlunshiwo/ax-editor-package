...
var StaticControl = /** @class */ (function (_super) {
    ...
    StaticControl.prototype.render = function () {
        var _a = this.props, className = _a.className, value = _a.value, label = _a.label, type = _a.type, render = _a.render, children = _a.children, rest = tslib_1.__rest(_a, ["className", "value", "label", "type", "render", "children"]);
        ...
        return (react_1.default.createElement("div", { className: "form-control-static" }, render('field', tslib_1.__assign(tslib_1.__assign({}, field), { type: 'static-field', field: field }), {
            value: value,
            className: className,
