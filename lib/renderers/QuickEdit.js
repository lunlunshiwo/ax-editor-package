...
var matches = require("dom-helpers/query/matches");
...
var inited = false;
var currentOpened;
exports.HocQuickEdit = function (config) {
    ...
    return function (Component) {
        var QuickEditComponent = /** @class */ (function (_super) {
            ...
            QuickEditComponent.prototype.handleSubmit = function (values) {
                ...
                this.closeQuickEdit();
                onQuickChange(values, quickEdit.saveImmediately);
            };
            ...
            QuickEditComponent.prototype.buildSchema = function () {
                var _a = this.props, quickEdit = _a.quickEdit, name = _a.name, label = _a.label;
                var schema;
                if (quickEdit === true) {
                    schema = {
                        type: 'form',
                    ...
                    if ((quickEdit.controls &&
                        ...
                        quickEdit.tabs ||
                        quickEdit.fieldSet) {
                        schema = tslib_1.__assign(tslib_1.__assign({ title: '', autoFocus: quickEdit.mode !== 'inline', mode: quickEdit.mode === 'inline'
                                ? 'inline'
                                : 'normal' }, quickEdit), { type: 'form' });
                    }
                    else {
                        schema = {
                            title: '',
                            ...
                            mode: quickEdit.mode === 'inline'
                                ? 'inline'
                                : 'normal',
                            controls: [
                                tslib_1.__assign({ type: quickEdit.type || 'text', name: quickEdit.name || name }, quickEdit)
                            ]
                        };
                    }
                }
                if (schema) {
                    schema = tslib_1.__assign(tslib_1.__assign({}, schema), { wrapWithPanel: quickEdit.mode !== 'inline', actions: quickEdit.mode === 'inline'
                            ? []
                            : [
                                {
                                    type: 'button',
            ...
            QuickEditComponent.prototype.renderPopOver = function () {
                var _this = this;
                var _a = this.props, quickEdit = _a.quickEdit, render = _a.render, popOverContainer = _a.popOverContainer, ns = _a.classPrefix, cx = _a.classnames;
                var content = (react_1.default.createElement("div", { className: cx(quickEdit.className) }, render('quick-edit-form', this.buildSchema(), {
                    onSubmit: this.handleSubmit,
                    onAction: this.handleAction,
                    onChange: null,
                    ref: this.formRef,
                    popOverContainer: popOverContainer ? function () { return _this.overlay; } : null
                })));
                popOverContainer = popOverContainer || (function () { return react_dom_1.findDOMNode(_this); });
                return (react_1.default.createElement(Overlay_1.default, { container: popOverContainer, target: function () { return _this.target; }, onHide: this.closeQuickEdit, show: true },
                    react_1.default.createElement(PopOver_1.default, { classPrefix: ns, ref: this.overlayRef, className: cx(ns + "QuickEdit-popover", quickEdit.popOverClassName), onHide: this.closeQuickEdit, overlay: true }, content)));
            };
            QuickEditComponent.prototype.render = function () {
                var _a = this.props, onQuickChange = _a.onQuickChange, quickEdit = _a.quickEdit, quickEditEnabled = _a.quickEditEnabled, className = _a.className, cx = _a.classnames, render = _a.render, noHoc = _a.noHoc;
                ...
                if (quickEdit.mode === 'inline') {
                    return (react_1.default.createElement(Component, tslib_1.__assign({}, this.props), render('inline-form', this.buildSchema(), {
                    ...
                    return (react_1.default.createElement(Component, tslib_1.__assign({}, this.props, { className: cx("Field--quickEditable", className, {
                        ...
                        react_1.default.createElement("i", { key: "edit-btn", className: cx('Field-quickEditBtn fa fa-edit'), onClick: this.openQuickEdit }),
