...
export declare type SchemaNode = number | string | Schema | SchemaArray;
...
declare type RendererDataAlis = RendererData;
...
export declare type Omit<T, K extends keyof T & any> = Pick<T, Exclude<keyof T, K>>;
export declare type Override<M, N> = Omit<M, Extract<keyof M, keyof N>> & N;
export declare type ExtractProps<TComponentOrTProps> = TComponentOrTProps extends React.ComponentType<infer P> ? P : never;
export {};
