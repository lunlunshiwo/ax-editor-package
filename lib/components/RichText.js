...
].forEach(function (init) { return init(); });
// Require Editor CSS files.
/*@require froala-editor/css/froala_style.min.css*/;
/*@require froala-editor/css/froala_editor.pkgd.min.css*/;
var FroalaEditor = /** @class */ (function (_super) {
    tslib_1.__extends(FroalaEditor, _super);
    ...
    FroalaEditor.prototype.textareaRef = function (ref) {
        ref ? this.createEditor(ref) : this.destroyEditor();
    };
    FroalaEditor.prototype.createEditor = function (ref) {
    ...
    FroalaEditor.prototype.setContent = function (firstTime) {
    ...
    FroalaEditor.prototype.setNormalTagContent = function (firstTime) {
        var self = this;
        function htmlSet() {
    ...
    FroalaEditor.prototype.getEditor = function () {
        if (this.$element) {
            return this.$element.froalaEditor.bind(this.$element);
        }
        return null;
    };
    FroalaEditor.prototype.updateModel = function () {
    ...
    FroalaEditor.prototype.initListeners = function () {
        var self = this;
    ...
    FroalaEditor.prototype.registerEvent = function (element, eventName, callback) {
    ...
    FroalaEditor.prototype.registerEvents = function () {
    ...
    FroalaEditor.prototype.destroyEditor = function () {
        if (this.$element) {
